...
from cloudshell.networking.brocade.nos.brocade_nos_resource_driver import BrocadeNOSDriver
import types
from cloudshell.shell.core.context import AutoLoadCommandContext


class BrocadeNOSDriverUnitTest(TestCase):
    ...
    def setUp(self):
        ...
        self.driver = BrocadeNOSDriver(config, test_bindings)
